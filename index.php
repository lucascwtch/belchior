...
<head>
    ...
    <link rel="stylesheet" href="https://kit.fontawesome.com/02be871dc7.css" crossorigin="anonymous">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                <button type="button"
                                                    class="btn btn-black botao-conhecer">Conhecer</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                <button type="button"
                                                    class="btn btn-primary botao-conhecer">Conhecer</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="row">
                <div class="col-sm-12 col-md-6 col-lg-3 ftco-animate d-flex">
                    <div class="product d-flex flex-column">
                        <a href="#" class="img-prod"><img class="img-fluid" src="assets/img/produto-01.png"
                        ...
                        <div class="text py-3 pb-4 px-3">
                            ...
                            <p class="bottom-area d-flex px-3">
                                ...
                                <a href="#" class="buy-now text-center py-2">COMPRAR AGORA<span><i
                ...
                <div class="col-sm-12 col-md-6 col-lg-3 ftco-animate d-flex">
                    <div class="product d-flex flex-column">
                        <a href="#" class="img-prod"><img class="img-fluid" src="assets/img/produto-02.png"
                                alt="Colorlib Template">
                        ...
                        <div class="text py-3 pb-4 px-3">
                            ...
                            <div class="pricing">
                                <p class="price"><span class="mr-2 price-dc">R$550.00</span><span
                                        class="price-sale">$225.00</span></p>
                            </div>
                            <p class="bottom-area d-flex px-3">
                                <a href="#" class="add-to-cart text-center py-2 mr-1"><span>Carrinho <i
                                            class="ion-ios-add ml-1"></i></span></a>
                ...
                <div class="col-sm-12 col-md-6 col-lg-3 ftco-animate d-flex">
                    <div class="product">
                        <a href="#" class="img-prod"><img class="img-fluid" src="assets/img/produto-03.png"
                                alt="Colorlib Template">
                            <div class="overlay"></div>
                        </a>
                        <div class="text py-3 pb-4 px-3">
                ...
                <div class="col-sm-12 col-md-6 col-lg-3 ftco-animate d-flex">
                    <div class="product">
                        <a href="#" class="img-prod"><img class="img-fluid" src="assets/img/produto-04.png"
                                alt="Colorlib Template">
                            <div class="overlay"></div>
                        </a>
                        <div class="text py-3 pb-4 px-3">
                ...
                <div class="col-sm-12 col-md-6 col-lg-3 ftco-animate d-flex">
                    <div class="product d-flex flex-column">
                        <a href="#" class="img-prod"><img class="img-fluid" src="assets/img/produto-05.png"
                                alt="Colorlib Template">
                            <div class="overlay"></div>
                        </a>
                        <div class="text py-3 pb-4 px-3">
                ...
                <div class="col-sm-12 col-md-6 col-lg-3 ftco-animate d-flex">
                    <div class="product d-flex flex-column">
                        <a href="#" class="img-prod"><img class="img-fluid" src="assets/img/produto-06.png"
                                alt="Colorlib Template">
                            <span class="status">50% Off</span>
                            <div class="overlay"></div>
                        </a>
                        <div class="text py-3 pb-4 px-3">
                            ...
                            <div class="pricing">
                                <p class="price"><span class="mr-2 price-dc">R$80.00</span><span
                                        class="price-sale">R$40.00</span></p>
                            </div>
                            <p class="bottom-area d-flex px-3">
                                <a href="#" class="add-to-cart text-center py-2 mr-1"><span>Carrinho <i
                                            class="ion-ios-add ml-1"></i></span></a>
                ...
                <div class="col-sm-12 col-md-6 col-lg-3 ftco-animate d-flex">
                    <div class="product">
                        <a href="#" class="img-prod"><img class="img-fluid" src="assets/img/produto-07.png"
                                alt="Colorlib Template">
                            <div class="overlay"></div>
                        </a>
                        <div class="text py-3 pb-4 px-3">
                ...
                <div class="col-sm-12 col-md-6 col-lg-3 ftco-animate d-flex">
                    <div class="product">
                        <a href="#" class="img-prod"><img class="img-fluid" src="assets/img/produto-08.png"
                                alt="Colorlib Template">
                            <div class="overlay"></div>
                        </a>
                        <div class="text py-3 pb-4 px-3">
                ...
                <div class="col-md">
                    <div class="ftco-footer-widget mb-4">
                        ...
                        <div class="block-23 mb-3">
                            <ul>
                                <li><span class="icon icon-map-marker"></span><span class="text">Rua Carlos De Carvalho,
                                        200</span></li>
