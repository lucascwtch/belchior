...
class ProductDAO {
    ...
    public function uploadProduct($nomeProduto, $categoriaProduto, $descricaoProduto, $precoProduto, $estoqueProduto, $tamanhoProduto,  $imagemProduto, $fkIdUsuario) {
        ...
        if (move_uploaded_file($imagemProduto['tmp_name'], $imagem_destino)) {
            ...
            $sql = "INSERT INTO produtos (nomeProduto, categoriaProduto, descricaoProduto, precoProduto, estoqueProduto, tamanhoProduto, imagemProduto, fkUsuario) VALUES (?, ?, ?, ?, ?, ?, ?,?)";
            $query = $this->db->prepare($sql);
            $query->execute([$nomeProduto, $categoriaProduto, $descricaoProduto, $precoProduto, $estoqueProduto,$tamanhoProduto,  $imagemProduto['name'], $fkIdUsuario]);
