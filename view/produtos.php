    ...
    <div class="container">
      <div class="row no-gutters slider-text align-items-center justify-content-center">
        <div class="col-md-9 ftco-animate text-center">
          <p class="breadcrumbs"><span class="mr-2"><a href="../index.html">Início</a></span> <span>PRODUTOS</span></p>
        ...
        <div class="col-lg-5">
          <div class="services-flow">
            <div class="services-2 p-4 d-flex ftco-animate">
              ...
              <div class="text">
                <h3>Frete Grátis</h3>
                <p class="mb-0">Desfrute de frete grátis em todas as suas compras. Seu produto chegará até você sem
                  custos adicionais.</p>
              </div>
            </div>
            <div class="services-2 p-4 d-flex ftco-animate">
              ...
              <div class="text">
                ...
                <p class="mb-0">Receba presentes valiosos em cada compra. Queremos tornar sua experiência de compra
            ...
            <div class="services-2 p-4 d-flex ftco-animate">
              ...
              <div class="text">
                ...
                <p class="mb-0">Nosso suporte está disponível 24 horas por dia, 7 dias por semana. Estamos aqui para
            ...
            <div class="services-2 p-4 d-flex ftco-animate">
              ...
              <div class="text">
                <h3>Suporte o Dia Todo</h3>
                <p class="mb-0">Conte com nosso suporte dedicado a qualquer momento. Estamos prontos para atendê-lo
          ...
          <div class="carousel-testimony owl-carousel">
            <div class="item">
              <div class="testimony-wrap">
                ...
                <div class="text">
                  <p class="mb-4 pl-4 line">Estou impressionado com a qualidade dos produtos. O frete grátis foi um
            ...
            <div class="item">
              <div class="testimony-wrap">
                ...
                <div class="text">
                  <p class="mb-4 pl-4 line">A entrega foi rápida, e os presentes valiosos foram uma surpresa
