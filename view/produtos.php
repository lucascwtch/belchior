        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-lg-10 order-md-last">
                    <div class="row">
                        <?php
                require_once "../controller/listarProdutosGeralController.php";
              ...
              ?>
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
                            <div class="product d-flex flex-column">
                                <a href="#" class="img-prod"><img class="img-fluid" src="../assets/img/produtos/<?= $product['imagemProduto'] ?>"
                                        ...
                                        <div class="panel-heading" role="tab" id="headingOne">
                                            <h4 class="panel-title">
                                                <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne"
                                                    aria-expanded="true" aria-controls="collapseOne">Calçados Masculinos
                                                </a>
                                            </h4>
                                        </div>
                                        <div id="collapseOne" class="panel-collapse collapse" role="tabpanel"
                                            ...
                                            <div class="panel-body">
                                                <ul>
                                                    ...
                                                    <li><a href="#">Casuais</a></li>
                                                    <li><a href="#">Corrida</a></li>
                                                    <li><a href="#">Jordan</a></li>
                                                    <li><a href="#">Futebol</a></li>
                                                    <li><a href="#">Futebol Americano</a></li>
                                        ...
                                        <div class="panel-heading" role="tab" id="headingTwo">
                                            <h4 class="panel-title">
                                                <a class="collapsed" data-toggle="collapse" data-parent="#accordion"
                                                    ...
                                                    aria-controls="collapseTwo">Calçados Femininos
                                                </a>
                                            </h4>
                                        </div>
                                        ...
                                        <div class="panel-heading" role="tab" id="headingThree">
                                            <h4 class="panel-title">
                                                <a class="collapsed" data-toggle="collapse" data-parent="#accordion"
                                                    ...
                                                    aria-controls="collapseThree">Acessórios
                                                </a>
                                            </h4>
                                        </div>
                                        ...
                                        <div class="panel-heading" role="tab" id="headingFour">
                                            <h4 class="panel-title">
                                                <a class="collapsed" data-toggle="collapse" data-parent="#accordion"
                                                    ...
                                                    aria-controls="collapseThree">Roupas
                                                </a>
                                            </h4>
                                        </div>
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="services-flow">
                        <div class="services-2 p-4 d-flex ftco-animate">
                            ...
                            <div class="text">
                                <h3>Frete Grátis</h3>
                                <p class="mb-0">Desfrute de frete grátis em todas as suas compras. Seu produto chegará
                                    até você sem
                                    custos adicionais.</p>
                            </div>
                        </div>
                        <div class="services-2 p-4 d-flex ftco-animate">
                            ...
                            <div class="text">
                                <h3>Presentes Valiosos</h3>
                                <p class="mb-0">Receba presentes valiosos em cada compra. Queremos tornar sua
                        ...
                        <div class="services-2 p-4 d-flex ftco-animate">
                            ...
                            <div class="text">
                                <h3>Suporte o Dia Todo</h3>
                                <p class="mb-0">Nosso suporte está disponível 24 horas por dia, 7 dias por semana.
                                    Estamos aqui para
                                    ajudar em qualquer momento.</p>
                            </div>
                        </div>
                        <div class="services-2 p-4 d-flex ftco-animate">
                            <div class="icon">
                            ...
                            <div class="text">
                                <h3>Suporte o Dia Todo</h3>
                                <p class="mb-0">Conte com nosso suporte dedicado a qualquer momento. Estamos prontos
                                    para atendê-lo
                ...
                <div class="col-lg-7">
                    <div class="heading-section ftco-animate mb-5">
                        <h2 class="mb-4">O que nossos clientes satisfeitos dizem</h2>
                        <p>Descubra o que nossos clientes têm a dizer sobre suas experiências de compra. </p>
                    </div>
                    <div class="carousel-testimony owl-carousel">
                        <div class="item">
                            <div class="testimony-wrap">
                                ...
                                <div class="text">
                                    <p class="mb-4 pl-4 line">Estou impressionado com a qualidade dos produtos. O frete
                                        grátis foi um
                                        bônus adicional. Recomendo totalmente!</p>
                        ...
                        <div class="item">
                            <div class="testimony-wrap">
                                ...
                                <div class="text">
                                    <p class="mb-4 pl-4 line">A entrega foi rápida, e os presentes valiosos foram uma
                                        surpresa
                                        encantadora. Definitivamente, farei mais compras aqui!</p>
                                    <p class="name">Will Thinkerson</p>
                                    <span class="position">Designer de Interface</span>
                                </div>
                            </div>
                        </div>
                        <!-- Adicione mais depoimentos conforme necessário com ícones do Font Awesome -->
                    </div>
                </div>
            </div>
        </div>
